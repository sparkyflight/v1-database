...
// MongoURLs
const main = `mongodb+srv://select:PPA10082@nightmareproject.5en4i6u.mongodb.net/${
	process.env.ENV === "production" ? "nightmarebot" : "development"
}?retryWrites=true&w=majority`;
const secondary = `mongodb+srv://select:PPA10082@nightmareproject.5en4i6u.mongodb.net/${
	process.env.ENV === "production" ? "development" : "nightmarebot"
}?retryWrites=true&w=majority`;
